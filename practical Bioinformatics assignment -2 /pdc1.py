...
start_position = 232390
end_position = 234081

downloaded_gene_sequence_record = fasta(email,
    accession_number, start_position, end_position, flag=True)

output_file = "PDC1.fasta"
